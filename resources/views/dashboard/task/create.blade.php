<x-layouts.dashboard-layout :showHeader="true" :metaData="$metaData">
    ...
    <form method="post" id="formToValidate" action="{{ route('dashboard.task.edit.post', ['id' => encrypt(0)]) }}">
        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <input type="text" name="code"
                                            ...
                                            value="{{ old('code') }}" placeholder="{{ __('dashboard.code') }}"
                                            required>
                                        <i
                                            class="ri-pencil-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                    </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group position-relative">
                                        <select class="form-select form-control ps-5 h-58" name="task_category_id"
                                            ...
                                            @foreach ($categoryData as $data)
                                                <option value="{{ $data->id }}" class="text-dark"
                                                    @if ($data->id == old('task_category_id')) selected="selected" @endif>
                                                    {{ $data->title }}</option>
                                            @endforeach
                                        </select>
                                        <i
