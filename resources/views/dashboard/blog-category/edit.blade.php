<x-layouts.dashboard-layout :showHeader="true" :metaData="$metaData">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h4 class="fw-semibold fs-18 border-bottom pb-20 mb-20">{{ __('dashboard.blog_category') }} {{ __('dashboard.edit') }}</h4>
                    @if ($errors->any())
        ...
        <div class="col-lg-4">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <h4 class="fw-semibold fs-18 border-bottom pb-20 mb-20">{{ __('dashboard.blog_category') }} {{ __('dashboard.image') }}</h4>
